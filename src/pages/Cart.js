...
export default function Cart() {
  ...
  const getErrorMessage = (message) => {
    ...
    if (message === "Customer location is required") {
  ...
  const calculateDeliveryPrice = async () => {
    ...
    try {
      ...
      toast.success(t.deliveryPriceCalculated || t.calculateDeliveryPrice);
    } catch (error) {
      console.error(error);
            ...
            >
              ...
              <div className="checkout-summary">
                ...
                <div>
                  ...
                  <strong>
                    {deliveryFee === null ? t.notCalculated : `₪ ${deliveryFee}`}
                  </strong>
                </div>
              ...
              >
                {calculatingDelivery
                  ...
                  : t.calculateDeliveryPrice}
              </button>

              <button
                className="confirm-order-btn"
                onClick={placeOrder}
                disabled={loadingOrder || deliveryFee === null}
              >
