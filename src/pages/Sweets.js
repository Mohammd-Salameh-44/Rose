...
export default function Sweets() {
  ...
  useEffect(() => {
    const loadProducts = async () => {
      ...
      setProducts(data.filter((p) => p.page === "sweets" && !p.hidden));
    };
          ...
          >
            ...
            >
              ...
              <div className="product-quantity">
                ...
                <span>{formatQuantity(quantity, selected.unit)} {getUnitLabel(selected.unit)}</span>
